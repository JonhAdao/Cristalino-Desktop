...
import br.com.manicure.gui.pacote.PacoteEditar;
...
public class EditarCliente extends javax.swing.JFrame {
     ...
     * @param ct
     */
    public EditarCliente(Agenda agenda, Cliente ct) {
        initComponents();
        this.agenda = agenda;
        this.cliente = ct;
        ...
        tNome.setText(ct.getNome());
        tCPF.setText(ct.getCpf());
        tRG.setText(ct.getRg());
        tDataNasc.setText(Formatacao.setDateMask(ct.getDataNasc()));
        tCelular.setText(ct.getContato().getCelular());
        tCEP.setText(ct.getEndereco().getCep());
        tRua.setText(ct.getEndereco().getRua());
        tNumero.setText(String.valueOf(ct.getEndereco().getNumero()));
        tBairro.setText(ct.getEndereco().getBairro());
        tCidade.setText(ct.getEndereco().getCidade());
        tEstado.setText(ct.getEndereco().getEstado());
        tEmail.setText(ct.getContato().getEmail());
        boxSexo.setSelectedItem(ct.getSexo());

        if (ct.getPacote() != null && ct.getPacote().getIdPacote() != 0) {
            rbSim.setSelected(true);
        } else {
            rbNao.setSelected(true);
        }

        tObservacao.setText(ct.getObservacao());
    ...
    private void initComponents() {
        ...
        bAlterarPacote = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setPreferredSize(new java.awt.Dimension(772, 651));
        ...
        bAlterarPacote.setText("Alterar Pacote");
        bAlterarPacote.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                bAlterarPacoteMouseClicked(evt);
            }
        });
        input.add(bAlterarPacote, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 360, -1, -1));
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(input, javax.swing.GroupLayout.DEFAULT_SIZE, 652, Short.MAX_VALUE)
        );
    ...
    private void bAlterarPacoteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_bAlterarPacoteMouseClicked
        PacoteEditar pacotes = new PacoteEditar(this);
        pacotes.setVisible(true);

    }//GEN-LAST:event_bAlterarPacoteMouseClicked
 ...
 /*   java.awt.EventQueue.invokeLater(new Runnable() {
    ...
    private javax.swing.JButton bAlterarPacote;
    ...
    public void editar() {
        ...
        if (Validacao.CPFexists(CPF, this.cliente.getId())) {
        ...
        if (pacote != null) {
            ...
            c.setPacote(p);
        } else if (cliente.getPacote().getIdPacote() != 0) {
            c.setPacote(cliente.getPacote());
        }
        ...
        c.setEndereco(e);
        c.setContato(co);
        c.setSexo((String) boxSexo.getSelectedItem());
        c.setObservacao(tObservacao.getText());

        DAOFactory.getClienteDAO().editar(c);
        JOptionPane.showMessageDialog(null, "A Alteração foi efetuado com sucesso", "Sucesso", JOptionPane.INFORMATION_MESSAGE);
        List<Cliente> lista = DAOFactory.getClienteDAO().listar();
        if (lista != null) {
            this.agenda.tableModelClientes.addLista(lista);
            this.dispose();
        } else {
            JOptionPane.showMessageDialog(null, "Ocorreu um erro ao realizar a alteração. Tente novamente mais tarde ou contate o Administrador do sistema", "Atenção", JOptionPane.WARNING_MESSAGE);
        }
    }
